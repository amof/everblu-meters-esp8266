...
void EverbluCyble::decodeBufferReceived(uint8_t *decoded_buffer, uint8_t size)
{
    ...
    current_index = decoded_buffer[INDEX_CURRENT_INDEX] | (decoded_buffer[INDEX_CURRENT_INDEX + 1] << 8) | (decoded_buffer[INDEX_CURRENT_INDEX + 2] << 16) | (decoded_buffer[INDEX_CURRENT_INDEX + 3] << 24);
